...
Además del archivo anterior, dando click aquí podra encontrar dos archivos .py, en uno de estos (Libreria_Complejos) se encuentran todas las funciones presentadas en el archivo .ipynb y en el otro un test de prueba con el que se puede verificar que estas funcionan correctamente.
